...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = 728074850;
...
fn wire__crate__api__appmenu__find_icon_path_from_icon_name_impl(
    port_: flutter_rust_bridge::for_generated::MessagePort,
    ptr_: flutter_rust_bridge::for_generated::PlatformGeneralizedUint8ListPtr,
    rust_vec_len_: i32,
    data_len_: i32,
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_normal::<flutter_rust_bridge::for_generated::SseCodec, _, _>(
        flutter_rust_bridge::for_generated::TaskInfo {
            debug_name: "find_icon_path_from_icon_name",
            port: Some(port_),
            mode: flutter_rust_bridge::for_generated::FfiCallMode::Normal,
        },
        move || {
            ...
            let mut deserializer =
                flutter_rust_bridge::for_generated::SseDeserializer::new(message);
            let api_icon_name = <String>::sse_decode(&mut deserializer);
            deserializer.end();
            move |context| {
                transform_result_sse::<_, ()>((move || {
                    let output_ok = Result::<_, ()>::Ok(
                        crate::api::appmenu::find_icon_path_from_icon_name(api_icon_name),
                    )?;
                    Ok(output_ok)
                })())
            }
        ...
        move || {
            ...
            move |context| async move {
                transform_result_sse::<_, ()>(
                    (move || async move {
                        let output_ok =
                            Result::<_, ()>::Ok(crate::api::mpris::get_mpris_data().await)?;
                        Ok(output_ok)
                    })()
                    .await,
                )
...
fn pde_ffi_dispatcher_primary_impl(
    ...
    match func_id {
        1 => wire__crate__api__wifi__connect_to_wifi_impl(port, ptr, rust_vec_len, data_len),
        2 => {
            wire__crate__api__hyprland__dispatch_kill_active_impl(port, ptr, rust_vec_len, data_len)
        }
        3 => wire__crate__api__hyprland__dispatch_switch_workspace_next_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        4 => wire__crate__api__hyprland__dispatch_switch_workspace_previous_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        5 => wire__crate__api__init__enable_rust_stacktrace_impl(port, ptr, rust_vec_len, data_len),
        6 => wire__crate__api__appmenu__find_icon_path_from_icon_name_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        7 => wire__crate__api__hyprland__get_active_window_title_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        8 => wire__crate__api__hyprland__get_active_workspace_number_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        9 => wire__crate__api__appmenu__get_all_apps_impl(port, ptr, rust_vec_len, data_len),
        10 => wire__crate__api__battery__get_battery_data_impl(port, ptr, rust_vec_len, data_len),
        11 => wire__crate__api__brightness__get_brightness_impl(port, ptr, rust_vec_len, data_len),
        ...
        14 => wire__crate__api__battery__get_power_profile_impl(port, ptr, rust_vec_len, data_len),
        15 => wire__crate__api__wireplumber__get_volume_impl(port, ptr, rust_vec_len, data_len),
        16 => wire__crate__api__wifi__get_wifi_list_impl(port, ptr, rust_vec_len, data_len),
        17 => wire__crate__api__hyprland__get_workspaces_impl(port, ptr, rust_vec_len, data_len),
        18 => wire__crate__api__appmenu__launch_app_impl(port, ptr, rust_vec_len, data_len),
        ...
        22 => wire__crate__api__battery__power_control_impl(port, ptr, rust_vec_len, data_len),
        23 => {
            wire__crate__api__brightness__set_brightness_all_impl(port, ptr, rust_vec_len, data_len)
        }
        24 => wire__crate__api__battery__set_power_profile_impl(port, ptr, rust_vec_len, data_len),
