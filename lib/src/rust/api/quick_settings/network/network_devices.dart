...
// These function are ignored because they are on traits that is not defined in current crate (put an empty `#[frb]` on it to unignore): `assert_receiver_is_total_eq`, `assert_receiver_is_total_eq`, `clone`, `clone`, `eq`, `eq`, `try_from_primitive`, `try_from_primitive`, `try_from`, `try_from`
...
// Rust type: RustOpaqueMoi<flutter_rust_bridge::for_generated::RustAutoOpaqueInner<NetworkDevice>>
abstract class NetworkDevice implements RustOpaqueInterface {
  InternetDeviceState get devState;

  DeviceType get devType;

  String get devicePath;

  String get iface;

  set devState(InternetDeviceState devState);

  set devType(DeviceType devType);

  set devicePath(String devicePath);

  set iface(String iface);
}
